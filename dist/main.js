...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_involvementAPI__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/involvementAPI */ \"./src/modules/involvementAPI.js\");\n\n\n\nconst gameId = 'T0GqmEuAfMsAPA8BNA8s'; // game name: 'Dilsher'\nconst myAPIurl = 'https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/';\nconst likesURL = `${myAPIurl}/${gameId}/likes`\n\n;(0,_modules_involvementAPI__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(likesURL);\nfetch('https://fakestoreapi.com/products')\n  .then(res => res.json())\n  .then(data => {\n    console.log(data)\n    let apidata = '';\n    data.map((value) => {\n      apidata += `\n      <tr class=\"my-auto align-middle d-flex justify-content-between\">\n        <td class=\"img\"><img src=\"${value.image}\" class=\"align-items-center\"></td>\n        <td>\n          <div>\n            <span>Category: </span>\n            <span>${value.category}</span>\n          </div>\n          <div>\n            <span>Price: </span>\n            <span>${value.price} PKR</span>\n          </div>\n        </td>\n        <td>\n          <button type=\"submit\" class=\"btn\">Add to cart</button>\n          <div class=\"d-inline-block\">\n            <button type=\"submit\" class=\"btn\">Like() \n              <i class=\"fa fa-heart\"></i>\n            </button>\n          </div>\n        </td>\n      </tr>\n      `\n    })\n    document.getElementById('display').innerHTML = apidata;\n  })\n\n//# sourceURL=webpack://set-up-webpack/./src/index.js?");
